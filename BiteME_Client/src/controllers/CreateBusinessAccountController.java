 ...
 * create business account interface and will run after clicking on create business account
...
public class CreateBusinessAccountController implements Initializable {
	 ...
	 * else checks if the ceiling>0 if no an error is displayed else the info are collected 
	 * in an arraylist and updated in the database
	 * @param event this argument will be sent to the method after clicking on
	 *       register button
	 */
	@FXML
